Tracksidentity::Application.configure do
  ...
  config.static_cache_control = "max-age=31536000, private"  # Cache static assets for atleast 1 year
  ...
  config.action_mailer.default_url_options = { :host => 'secure.tracksgiving.com' }
